...
stimuli_set1, _ = make_set_from_specs(**creation_params, set_size=200,
...
stimuli_set2, _ = make_set_from_specs(**creation_params, set_size=200,
                                   set_transform_function=set_transform_function,
                                   set_transform_params=set_transform_params,
...
stimuli_set3, _ = make_set_from_stimuli((stim_a, stim_b),
                                     stimulus_duration=creation_params['stimulus_duration'],
                                     set_size=200, 
                                     set_transform_function=set_transform_function,
                                     set_transform_params=set_transform_params)
