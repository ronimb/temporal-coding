...
experiment_name = 'lrnRate=5e-5_thresh=5e-2'  # This can be left empty to save without experiment name
...
with open(path.join(save_folder, f'{experiment_name}experiment_template.py'), 'wb') as template_file:
